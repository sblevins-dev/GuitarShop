...
export const staticData = [
  {
    "title": "Martin Special Birdseye HPL X Series LX Little Martin Acoustic Guitar",
    "price": "399.99",
    "salePrice": "499.99",
  ...
  {
    "title": "Fender Player Stratocaster HSS Plus Top Maple Fingerboard Limited-Edition Electric Guitar",
    "price": "749.99",
    "salePrice": null,
    "description": "Iconic electric guitar known for its sleek body, versatile sound, and smooth playability. Popular among rock, blues, and jazz musicians.",
    "id": 11,
  ...
  {
    "title": "Fender Player Telecaster Maple Fingerboard Electric Guitar",
    "price": "679.99",
    "salePrice": "799.99",
    "description": "Iconic electric guitar known for its sleek body, versatile sound, and smooth playability. Popular among rock, blues, and jazz musicians.",
    "id": 13,
  ...
  // {
  //   "title": "Rogue Rocketeer Electric Guitar Pack",
  //   "price": "219.99",
  //   "salePrice": null,
  //   "description": "Legendary solid-body electric guitar with a distinctive single-cutaway design. Renowned for its warm tone, sustain, and rich overtones.",
  //   "id": 19,
  ...
  // },
  // {
  //   "title": "Taylor 414ce V-Class Special-Edition Grand Auditorium Acoustic-Electric Guitar",
  //   "price": "2,999.00",
  //   "salePrice": "3,099.00",
  //   "description": "High-quality acoustic-electric guitar featuring a grand auditorium body shape, known for balanced tone and excellent projection. Ideal for both stage and studio.",
  //   "id": 20,
  ...
  // },
  // {
  //   "title": "Taylor 224ce-K DLX Grand Auditorium Acoustic-Electric Guitar",
  //   "price": "1,999.00",
  //   "salePrice": null,
  //   "description": "High-quality acoustic-electric guitar featuring a grand auditorium body shape, known for balanced tone and excellent projection. Ideal for both stage and studio.",
  //   "id": 21,
  ...
  // },
  {
    "title": "Fender FA-135CE Concert Acoustic-Electric Guitar",
    "price": "199.99",
    "salePrice": "249.99",
    "description": "Classic acoustic guitar celebrated for its deep, resonant sound and solid construction. A favorite among folk, country, and bluegrass musicians.",
    "id": 22,
